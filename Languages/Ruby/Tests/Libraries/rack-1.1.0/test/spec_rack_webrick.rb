...
context "Rack::Handler::WEBrick" do
  ...
  setup do
    @server = WEBrick::HTTPServer.new(:Host => @host='localhost', # '0.0.0.0', # jimmysch -- for some reason this doesn't work in ir
                                      :Port => @port=9202,
  ...
  specify "should be a WEBrick" do
    ...
    response["SERVER_NAME"].should.equal 'localhost' # "0.0.0.0" # jimmysch -- for some reason this doesn't work in ir
  end
