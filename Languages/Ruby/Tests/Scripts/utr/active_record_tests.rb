class UnitTestSetup
  ...
  def disable_tests
    ...
    disable AssociationsExtensionsTest, 
      ...
      # D:\vs_langs01_s\dlr\Languages\Ruby\Libraries.LCA_RESTRICTED\Builtins\Marshal.cs:718:in `ReadClassOrModule'
      # D:\vs_langs01_s\dlr\Languages\Ruby\Libraries.LCA_RESTRICTED\Builtins\Marshal.cs:768:in `ReadExtended'
      # D:\vs_langs01_s\dlr\Languages\Ruby\Libraries.LCA_RESTRICTED\Builtins\Marshal.cs:908:in `ReadAnObject'
    ...
    disable AssociationsTest, 
      ...
      # d:/vs_langs01_s/dlr/External.LCA_RESTRICTED/Languages/Ruby/redist-libs/ruby/1.8/pstore.rb:296:in `transaction'
      # d:/vs_langs01_s/dlr/External.LCA_RESTRICTED/Languages/IronRuby/tests/RailsTests-2.3.5/activerecord/test/cases/associations_test.rb:78:in `test_storing_in_pstore'
    ...
    disable BasicsTest, 
      ...
      # d:/vs_langs01_s/dlr/External.LCA_RESTRICTED/Languages/IronRuby/tests/RailsTests-2.3.5/activerecord/test/cases/base_test.rb:511:in `test_initialize_with_invalid_attribute'
      # d:/vs_langs01_s/dlr/External.LCA_RESTRICTED/Languages/Ruby/ruby-1.8.6p368/lib/ruby/gems/1.8/gems/test-unit-2.0.5/lib/test/unit/testsuite.rb:37:in `run'
      # d:/vs_langs01_s/dlr/External.LCA_RESTRICTED/Languages/Ruby/ruby-1.8.6p368/lib/ruby/gems/1.8/gems/test-unit-2.0.5/lib/test/unit/testsuite.rb:37:in `run'
    ...
    disable ConnectionTestSqlserver, 
      ...
      # d:/vs_langs01_s/dlr/External.LCA_RESTRICTED/Languages/Ruby/ruby-1.8.6p368/lib/ruby/gems/1.8/gems/activerecord-sqlserver-adapter-2.3/test/cases/connection_test_sqlserver.rb:76
      "test: ConnectionSqlserver should active closes statement. ",
      # RuntimeError: each_object only supported for objects of type Class or Module
      # D:\vs_langs01_s\dlr\Languages\Ruby\Libraries.LCA_RESTRICTED\Builtins\ObjectSpace.cs:37:in `each_object'
      # d:/vs_langs01_s/dlr/External.LCA_RESTRICTED/Languages/Ruby/ruby-1.8.6p368/lib/ruby/gems/1.8/gems/activerecord-sqlserver-adapter-2.3/test/cases/connection_test_sqlserver.rb:117:in `assert_all_statements_used_are_closed'
      # d:/vs_langs01_s/dlr/External.LCA_RESTRICTED/Languages/Ruby/ruby-1.8.6p368/lib/ruby/gems/1.8/gems/activerecord-sqlserver-adapter-2.3/test/cases/connection_test_sqlserver.rb:56
      "test: ConnectionSqlserver should execute with block closes statement. ",
      # RuntimeError: each_object only supported for objects of type Class or Module
      # D:\vs_langs01_s\dlr\Languages\Ruby\Libraries.LCA_RESTRICTED\Builtins\ObjectSpace.cs:37:in `each_object'
      # d:/vs_langs01_s/dlr/External.LCA_RESTRICTED/Languages/Ruby/ruby-1.8.6p368/lib/ruby/gems/1.8/gems/activerecord-sqlserver-adapter-2.3/test/cases/connection_test_sqlserver.rb:117:in `assert_all_statements_used_are_closed'
      # d:/vs_langs01_s/dlr/External.LCA_RESTRICTED/Languages/Ruby/ruby-1.8.6p368/lib/ruby/gems/1.8/gems/activerecord-sqlserver-adapter-2.3/test/cases/connection_test_sqlserver.rb:50
      "test: ConnectionSqlserver should execute without block closes statement. ",
      # RuntimeError: each_object only supported for objects of type Class or Module
      # D:\vs_langs01_s\dlr\Languages\Ruby\Libraries.LCA_RESTRICTED\Builtins\ObjectSpace.cs:37:in `each_object'
      # d:/vs_langs01_s/dlr/External.LCA_RESTRICTED/Languages/Ruby/ruby-1.8.6p368/lib/ruby/gems/1.8/gems/activerecord-sqlserver-adapter-2.3/test/cases/connection_test_sqlserver.rb:117:in `assert_all_statements_used_are_closed'
      # d:/vs_langs01_s/dlr/External.LCA_RESTRICTED/Languages/Ruby/ruby-1.8.6p368/lib/ruby/gems/1.8/gems/activerecord-sqlserver-adapter-2.3/test/cases/connection_test_sqlserver.rb:22
      "test: ConnectionSqlserver should finish DBI statment handle from #execute with block. ",
      # RuntimeError: each_object only supported for objects of type Class or Module
      # D:\vs_langs01_s\dlr\Languages\Ruby\Libraries.LCA_RESTRICTED\Builtins\ObjectSpace.cs:37:in `each_object'
      # d:/vs_langs01_s/dlr/External.LCA_RESTRICTED/Languages/Ruby/ruby-1.8.6p368/lib/ruby/gems/1.8/gems/activerecord-sqlserver-adapter-2.3/test/cases/connection_test_sqlserver.rb:117:in `assert_all_statements_used_are_closed'
      # d:/vs_langs01_s/dlr/External.LCA_RESTRICTED/Languages/Ruby/ruby-1.8.6p368/lib/ruby/gems/1.8/gems/activerecord-sqlserver-adapter-2.3/test/cases/connection_test_sqlserver.rb:34
      "test: ConnectionSqlserver should finish connection from #raw_select. ",
      # RuntimeError: each_object only supported for objects of type Class or Module
      # D:\vs_langs01_s\dlr\Languages\Ruby\Libraries.LCA_RESTRICTED\Builtins\ObjectSpace.cs:37:in `each_object'
      # d:/vs_langs01_s/dlr/External.LCA_RESTRICTED/Languages/Ruby/ruby-1.8.6p368/lib/ruby/gems/1.8/gems/activerecord-sqlserver-adapter-2.3/test/cases/connection_test_sqlserver.rb:117:in `assert_all_statements_used_are_closed'
      # d:/vs_langs01_s/dlr/External.LCA_RESTRICTED/Languages/Ruby/ruby-1.8.6p368/lib/ruby/gems/1.8/gems/activerecord-sqlserver-adapter-2.3/test/cases/connection_test_sqlserver.rb:64
    ...
    disable FixturesTest, 
      ...
      # ---Backtrace---
      # d:/vs_langs01_s/dlr/External.LCA_RESTRICTED/Languages/IronRuby/tests/RailsTests-2.3.5/activerecord/test/cases/fixtures_test.rb:165:in `test_omap_fixtures'
      # fixtures.rb:707:in `read_yaml_fixture_files'
      # D:\vs_langs01_s\dlr\Languages\Ruby\
      :test_omap_fixtures
    ...
    disable HasOneAssociationsTest, 
      ...
      # ---Backtrace---
      # D:\vs_langs01_s\dlr\Languages\Ruby\Libraries.LCA_RESTRICTED\Builtins\Marshal.cs:246:in `WriteHash'
      # D:\vs_langs01_s\dlr\Languages\Ruby\Libraries.LCA_RESTRICTED\Builtins\Marshal.cs:430:in `WriteAnObject'
      # D:\vs_langs01_s\dlr\Languages\Ruby\Libraries.LCA_RESTRICTED\Builtins\Marsha
    ...
    disable InvalidDateTest, 
      ...
      # d:/vs_langs01_s/dlr/External.LCA_RESTRICTED/Languages/IronRuby/test
    ...
    disable TestAutosaveAssociationOnAHasManyAssociation, 
      ...
      # d:/vs_langs01_s/dlr/External.LCA_RESTRICTED/Languages/IronRuby/tests/RailsTests-2.3.5/activerecord/test/cases/autosave_association_test.rb:970:in `save'
      # (eval):1
      # autosav
    ...
    disable UnicodeTestSqlserver, 
      ...
      # D:\vs_langs01_s\dlr\Languages\Ruby\Libraries.LCA_RESTRICTED\Extensions\IListOps.cs:1343:in `Join'
      # D:\vs_langs01_s\dlr\Languages\Ruby\Libraries.LCA_RESTRICTED\Extensions\IListOps.cs:1365:in `join'
      # d:/vs_langs01_s/dlr/External.LCA_RESTRICTED/Languages/Ruby/ruby-1.8.6p368/lib/ruby/gems/1.8/gems/test-unit-2.0.5/lib/test/unit/diff.rb:720:in `diff'
