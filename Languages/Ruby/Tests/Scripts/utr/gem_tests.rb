class UnitTestSetup
  ...
  def gather_files
    test_dir = File.expand_path("External.LCA_RESTRICTED/Languages/IronRuby/tests/RubyGems-1_3_5-test", ENV["DLR_ROOT"])
    $LOAD_PATH << test_dir

    # Note that the copy of minitest\unit.rb has a workaround at line 15 for http://redmine.ruby-lang.org/issues/show/1266
    ENV["GEM_PATH"] = File.expand_path("External.LCA_RESTRICTED/Languages/Ruby/ruby-1.8.6p368/lib/ruby/gems/1.8", ENV["DLR_ROOT"])
