...
class FormV6(Form):
    def __init__(self):
        ...
        self._tableLayoutPanel1 = TableLayoutPanel(ColumnCount=1, RowCount=2,
                                                   Dock=DockStyle.Fill)
        ...
        # when the enter key is pressed self._button1 will be clicked
        ...
        # Set TableLayoutPanel column and row styles
        # and add FlowLayoutPanel and Web Browser
