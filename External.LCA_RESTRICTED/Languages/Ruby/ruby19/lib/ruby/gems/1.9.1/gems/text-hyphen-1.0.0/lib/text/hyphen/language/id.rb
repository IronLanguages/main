...
Text::Hyphen::Language::IND = Text::Hyphen::Language::ID

Text::Hyphen::Language::MS = Text::Hyphen::Language::ID.new do |lang|; end
Text::Hyphen::Language::MAY = Text::Hyphen::Language::MS
Text::Hyphen::Language::MSA = Text::Hyphen::Language::MS
