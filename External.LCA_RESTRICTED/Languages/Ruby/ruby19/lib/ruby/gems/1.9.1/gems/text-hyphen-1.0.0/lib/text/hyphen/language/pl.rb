...
#
# Notation: ą  means  a with `ogonek'
#           ć   -->   ć
#           ę   -->   e with `ogonek'
#           ł   -->   \l
#           ń   -->   \'n
...
#           ż   -->   \.z
#
# If a slash is active we assume that it will expand appropriately,
# otherwise we activate it and define LOCALLY to make it behaving like
...
Text::Hyphen::Language::POL = Text::Hyphen::Language::PL
