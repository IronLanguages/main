...
if test_support.due_to_ironpython_bug("http://www.codeplex.com/IronPython/WorkItem/View.aspx?WorkItemId=23324"):
    # avoid non-deterministic GC when running against IronPython
    any = all
...
if test_support.due_to_ironpython_bug("http://www.codeplex.com/IronPython/WorkItem/View.aspx?WorkItemId=23324"):
    # the generator is not immediately collected
    generator_example.events[6] = (-6, 'call')
    generator_example.events[7] = (-3, 'line')
...
class TraceTestCase(unittest.TestCase):
    ...
    def test_08_settrace_and_return(self):
        if test_support.due_to_ironpython_bug("http://www.codeplex.com/IronPython/WorkItem/View.aspx?WorkItemId=23324"):
            # sys.settrace() doesn't work on functions higher in the stack
            return
