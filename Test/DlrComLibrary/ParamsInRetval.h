// ParamsIn.h : Declaration of the CParamsIn
...
class ATL_NO_VTABLE CParamsInRetval :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CParamsInRetval, &CLSID_ParamsInRetval>,
	public IDispatchImpl<IParamsInRetval, &IID_IParamsInRetval, &LIBID_DlrComLibraryLib, /*wMajor =*/ 1, /*wMinor =*/ 0>
{
public:
	CParamsInRetval()
	{
...
DECLARE_REGISTRY_RESOURCEID(IDR_PARAMSINRETVAL)


BEGIN_COM_MAP(CParamsInRetval)
	COM_INTERFACE_ENTRY(IParamsInRetval)
...
OBJECT_ENTRY_AUTO(__uuidof(ParamsInRetval), CParamsInRetval)
