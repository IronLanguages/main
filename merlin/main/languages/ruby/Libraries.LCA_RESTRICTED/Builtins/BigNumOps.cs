...
namespace IronRuby.Builtins {
    ...
    /// </summary>
    [RubyClass("Bignum", Inherits = typeof(Integer), Extends = typeof(BigInteger))]
    public sealed class BignumOps {

        #region Arithmetic Operators, -@, abs, +, -, *, /, div, quo, **, %, modulo, divmod, remainder
        ...
        public static bool Equal(BigInteger/*!*/ self, double other) {
            if (System.Double.IsNaN(other)) return false;
        ...
        [RubyMethod("==")]
        public static bool Equal(RubyContext/*!*/ context, BigInteger/*!*/ self, object other) {
