  ...
  class CommandContext
    ...
    def get_compile_path_list(csproj)
      ...
      if cs_proj_files.length == 1
        ...
        result.delete_if { |e| e =~ /(Silverlight\\SilverlightVersion.cs|System\\Dynamic\\ComInterop\\Parameterized.System.Dynamic.ComInterop.cs)/ }
...
class IronRuby < ProjectContext
  ...
  map :dlr_com, :merlin => 'ndp/fx/src/dynamiccom', :svn => 'src/dynamiccom'
