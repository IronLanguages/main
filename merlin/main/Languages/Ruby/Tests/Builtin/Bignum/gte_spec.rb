...
describe "Bignum#>=" do
  it "returns true if self is greater than or equal to other, where other is Bignum" do
  ...
  it "returns true if self is greater than or equal to other, where other is Fixnum" do
	(0x80000000 >= 10).should == true
	(-0x80000000 >= 10).should == false
	(0x80000000 >= -10).should == true
	(-0x80000000 >= -10).should == false
  end
  it "returns true if self is greater than or equal to other, where other is Float" do
