    ...
    public sealed class ReadOnlyCollectionBuilder<T> : IList<T>, System.Collections.IList {
        ...
        private static void ValidateNullValue(object value, string argument) {
            if (value == null && !(default(T) == null)) {
                throw new ArgumentException("The value null is not of type '{0}' and cannot be used in this collection.", argument);
            }
        }

        private static void ThrowInvalidTypeException(object value, string argument) {
            throw new ArgumentException(String.Format("The value '{0}' is not of type '{1}' and cannot be used in this collection.", 
                value != null ? value.GetType() : (object)"null", typeof(T)), argument);
        }
