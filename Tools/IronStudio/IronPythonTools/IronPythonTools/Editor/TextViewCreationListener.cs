...
namespace Microsoft.IronPythonTools.Editor {
    /// <summary>
    /// Watches for text views to be created for IronPython code.  Then wires up whatever event handling
    ...
    class TextViewCreationListener : IVsTextViewCreationListener {
        ...
        public void VsTextViewCreated(VisualStudio.TextManager.Interop.IVsTextView textViewAdapter) {
            ...
            if (textView != null) {
                BraceMatcher.WatchBraceHighlights(textView, IronPythonToolsPackage.ComponentModel);
            }
        }
    }
}
