...
namespace Microsoft.IronStudio.Project {    
    ...
    public sealed class SRDescriptionAttribute : DescriptionAttribute {
        ...
        public override string Description {
            get {
                if (!_replaced) {
                    _replaced = true;
                    DescriptionValue = DynamicProjectSR.GetString(base.Description);
                }
    ...
    public class DynamicProjectSR {
        ...
        internal DynamicProjectSR() {
            _resources = new ResourceManager("Microsoft.IronStudio.Project.LocalizableDisplayNameAttribute", this.GetType().Assembly);
        }
