...
namespace Microsoft.IronRubyTools.Commands {
    ...
    /// the command in CommandTable.  IronRubyToolsPackage will then register the command on startup.
    /// </summary>
    abstract class Command {
        ...
        /// <summary>
        /// Enables a command to hook into our edit filter for Ruby text buffers.
        /// 
