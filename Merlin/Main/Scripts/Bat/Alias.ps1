...
function global:bsrbd { cmd /C "msbuild ${env:MERLIN_ROOT}\Languages\Ruby\Ruby.sln /p:Configuration=`"Silverlight Debug`" /p:SilverlightPath=`"C:\Program Files\Microsoft Silverlight\3.0.50106.0`"" }
...
function global:ipym { cmd /C "mono `"${env:MERLIN_ROOT}\Bin\Debug\ipy.exe`" $args" }
function global:ipyrm { cmd /C "mono `"${env:MERLIN_ROOT}\Bin\Release\ipy.exe`" -X:TabCompletion $args" }
function global:ipydm { cmd /C "mono `"${env:MERLIN_ROOT}\Bin\Debug\ipy.exe`" -D -X:TabCompletion $args" }
...
function global:rbxm { cmd /C "mono `"${env:MERLIN_ROOT}\Bin\Debug\ir.exe`" $args" }
function global:rbrm { cmd /C "mono `"${env:MERLIN_ROOT}\Bin\Release\ir.exe`" $args" }
function global:rbdm { cmd /C "mono `"${env:MERLIN_ROOT}\Bin\Debug\ir.exe`" -D $args" }
