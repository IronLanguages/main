...
describe "Method parameter binding for collections" do
  ...
  @matrix = {
    ...
    "System::Array[IInterface]Instance" => {:NoArg => AE, :ObjectArrArg => "ObjectArrArg", :IInterfaceArrArg => "IInterfaceArrArg", :ParamsIInterfaceArrArg => "ParamsIInterfaceArrArg", :IInterfaceArgParamsIInterfaceArrArg => "IInterfaceArgParamsIInterfaceArrArg", :IListOfObjArg => "IListOfObjArg", :ArrayArg => "ArrayArg", :IEnumerableArg => "IEnumerableArg"},
    "System::Array[IInterface]InstanceEmpty" => {:NoArg => AE, :ObjectArrArg => "ObjectArrArg", :IInterfaceArrArg => "IInterfaceArrArg", :ParamsIInterfaceArrArg => "ParamsIInterfaceArrArg", :IInterfaceArgParamsIInterfaceArrArg => "IInterfaceArgParamsIInterfaceArrArg", :IListOfObjArg => "IListOfObjArg", :ArrayArg => "ArrayArg", :IEnumerableArg => "IEnumerableArg"},
