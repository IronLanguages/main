...
describe "Method parameter binding" do
  ...
  @matrix = {
    ...
    :a => {:NoArg => AE, :Int32Arg => "Int32Arg",
          :BigIntegerArg => "BigIntegerArg", :StringArg => "StringArg", :BooleanArg => "BooleanArg",
          :SByteArg => RE, :Int16Arg => RE, :Int64Arg => "Int64Arg", :ByteArg => RE,
          :UInt16Arg => RE, :UInt32Arg => "UInt32Arg", :UInt64Arg => "UInt64Arg",
          :ObjectArg => "ObjectArg" },
    :abc => {:NoArg => AE, :Int32Arg => "Int32Arg",
          :BigIntegerArg => "BigIntegerArg", :StringArg => "StringArg", :BooleanArg => "BooleanArg", 
          :SByteArg => RE, :Int16Arg => RE, :Int64Arg => "Int64Arg", :ByteArg => RE, 
          :UInt16Arg => RE, :UInt32Arg => "UInt32Arg", :UInt64Arg => "UInt64Arg",
          :ObjectArg => "ObjectArg" },
