...
class ClassExtTest
  # <[#<Class:0x0004da0 @inheritable_attributes={}>]> expected but was
  # <[]>.
...
class MessageVerifierTest
  # <{:some=>"data", :now=>Mon Sep 07 22:50:08 -07:00 2009}> expected but was
  # <{:some=>"data", :now=>Mon Sep 07 22:34:08 -07:00 2009}>.
  def test_simple_round_tripping() end
end

class MultibyteCharsExtrasTest
  # <"???? ????"> expected but was
  # <#<ActiveSupport::Multibyte::Chars:0x18d46
  #  @wrapped_string=
  ...
  # <#<ActiveSupport::Multibyte::Chars:0x18d84
...
class MultibyteCharsUTF8BehaviourTest
  # <"???? "> expected but was
  # <#<ActiveSupport::Multibyte::Chars:0x18fc8
  ...
  # <"?? ?"> expected but was
  # <#<ActiveSupport::Multibyte::Chars:0x19046
