...
# C:\M4\Merlin\External.LCA_RESTRICTED\Languages\Ruby\ruby-1.8.6p368\lib\ruby\gems\1.8\gems\rubygems-update-1.2.0\lib\rubygems\defaults.rb
RUBY_ENGINE = 'ruby'

# load_gems_in loads gems:
# C:\M4\Merlin\External.LCA_RESTRICTED\Languages\Ruby\ruby-1.8.6p368\lib\ruby\site_ruby\1.8\rubygems\source_index.rb

CURRENT_DIR = Dir.pwd
MERB_APP_ROOT = MERLIN_ROOT + "/../External.LCA_RESTRICTED/Languages/IronRuby/merb/test_app"
ENV['GEM_HOME'] = MERLIN_ROOT + "/../External.LCA_RESTRICTED/Languages/Ruby/ruby-1.8.6p368/lib/ruby/gems/1.8"
...
load MERLIN_ROOT + "/../External.LCA_RESTRICTED/Languages/Ruby/ruby-1.8.6p368/bin/merb"
