...
namespace IronRuby.Compiler {
    internal static partial class Methods {
        ...
        _GetUnqualifiedConstant, _HookupEvent, _InitializeBlock, _IsDefinedClassVariable, _IsDefinedGlobalConstant, _IsDefinedGlobalVariable, _IsDefinedInstanceVariable, _IsDefinedMethod, _IsDefinedObjectClassVariable, _IsDefinedQualifiedConstant, _IsDefinedUnqualifiedConstant, _IsFalse, _IsProcConverterTarget, _IsRetrySingleton, _IsSuperCallTarget, _IsTrue, _LeaveProcConverter, _MakeAmbiguousMatchError, _MakeArray0, _MakeArray1, 
        _MakeArray2, _MakeArray3, _MakeArray4, _MakeArray5, _MakeArrayN, _MakeHash, _MakeHash0, _MakeInvalidArgumentTypesError, _MakeMissingSuperException, _MakePrivateMethodCalledError, _MakeTopLevelSuperException, _MakeWrongNumberOfArgumentsError, _MatchLastInputLine, _MatchString, _MethodBreak, _MethodDefined, _MethodNext, _MethodProcCall, _MethodRedo, _MethodRetry, 
        _MethodYield, _PrintInteractiveResult, _PropagateRetrySingleton, _SerializeObject, _SetClassVariable, _SetCurrentException, _SetCurrentExceptionAndStackTrace, _SetGlobalConstant, _SetGlobalVariable, _SetInstanceVariable, _SetLocalVariable, _SetObjectClassVariable, _SetQualifiedConstant, _SetUnqualifiedConstant, _Splat, _SplatAppend, _SplatPair, _ToArrayValidator, _ToFixnumValidator, _ToFloatValidator, 
        _ToHashValidator, _ToIntegerValidator, _ToProcValidator, _ToRegexValidator, _ToSDefaultConversion, _ToStringValidator, _ToSymbolValidator, _TraceBlockCall, _TraceBlockReturn, _TraceMethodCall, _TraceMethodReturn, _TryGetClassVariable, _TryGetObjectClassVariable, _UndefineMethod, _Unsplat, _UpdateProfileTicks, _X, _Yield0, _Yield1, _Yield2, 
        _Yield3, _Yield4, _YieldN, _YieldSplat0, _YieldSplat1, _YieldSplat2, _YieldSplat3, _YieldSplat4, _YieldSplatN, _YieldSplatNRhs;
