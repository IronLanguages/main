...
namespace IronRuby.Compiler {
    internal static partial class Methods {
        private static MethodInfo _AliasGlobalVariable, _AliasMethod, _AllocateStructInstance, _BlockBreak, _BlockRetry, _BlockReturn, _BlockYield, _CanRescue, _CheckForAsyncRaiseViaThreadAbort, _CompareDefaultException, _CompareException, _CompareSplattedExceptions, _ConvertBignumToFixnum, _ConvertBignumToFloat, _ConvertFixnumToSymbol, _ConvertMutableStringToSymbol, _ConvertStringToFloat, _ConvertSymbolIdToSymbol, _CreateArgumentsError, 
        _CreateArgumentsErrorForMissingBlock, _CreateArgumentsErrorForProc, _CreateBfcForLibraryMethod, _CreateBfcForMethodProcCall, _CreateBfcForProcCall, _CreateBfcForYield, _CreateBlockScope, _CreateDelegateFromMethod, _CreateDelegateFromProc, _CreateEncoding, _CreateExclusiveIntegerRange, _CreateExclusiveRange, _CreateInclusiveIntegerRange, _CreateInclusiveRange, _CreateMainTopLevelScope, _CreateMethodScope, _CreateModuleEvalScope, _CreateModuleScope, _CreateMutableStringB, _CreateMutableStringBM, 
        _CreateMutableStringE, _CreateMutableStringEM, _CreateMutableStringM, _CreateMutableStringMB, _CreateMutableStringME, _CreateMutableStringMM, _CreateMutableStringMU, _CreateMutableStringN, _CreateMutableStringU, _CreateMutableStringUM, _CreateRegexB, _CreateRegexBM, _CreateRegexE, _CreateRegexEM, _CreateRegexM, _CreateRegexMB, _CreateRegexME, _CreateRegexMM, _CreateRegexMU, _CreateRegexN, 
        _CreateRegexU, _CreateRegexUM, _CreateRfcForMethod, _CreateStructInstance, _CreateSymbolB, _CreateSymbolBM, _CreateSymbolE, _CreateSymbolEM, _CreateSymbolM, _CreateSymbolMB, _CreateSymbolME, _CreateSymbolMM, _CreateSymbolMU, _CreateSymbolN, _CreateSymbolU, _CreateSymbolUM, _CreateTopLevelHostedScope, _CreateTopLevelScope, _CreateTypeConversionError, _CreateWrappedTopLevelScope, 
        _DefineBlock, _DefineClass, _DefineGlobalClass, _DefineGlobalModule, _DefineMethod, _DefineModule, _DefineNestedClass, _DefineNestedModule, _DefineSingletonClass, _DeserializeObject, _EvalBreak, _EvalNext, _EvalRedo, _EvalRetry, _EvalReturn, _EvalYield, _GetArrayItem, _GetArraySuffix, _GetClassVariable, _GetContextFromBlockParam, 
        _GetContextFromMethod, _GetContextFromProc, _GetContextFromScope, _GetCurrentException, _GetCurrentMatchData, _GetCurrentMatchGroup, _GetCurrentMatchLastGroup, _GetCurrentMatchPrefix, _GetCurrentMatchSuffix, _GetDefaultExceptionMessage, _GetEmptyScope, _GetGlobalConstant, _GetGlobalVariable, _GetInstanceData, _GetInstanceVariable, _GetLocalVariable, _GetMetaObject, _GetObjectClassVariable, _GetQualifiedConstant, _GetRetrySingleton, 
        _GetSelfClassVersionHandle, _GetUnqualifiedConstant, _HookupEvent, _InitializeBlock, _IsDefinedClassVariable, _IsDefinedGlobalConstant, _IsDefinedGlobalVariable, _IsDefinedInstanceVariable, _IsDefinedMethod, _IsDefinedObjectClassVariable, _IsDefinedQualifiedConstant, _IsDefinedUnqualifiedConstant, _IsFalse, _IsProcConverterTarget, _IsRetrySingleton, _IsSuperCallTarget, _IsTrue, _LeaveProcConverter, _MakeAmbiguousMatchError, _MakeArray0, 
        _MakeArray1, _MakeArray2, _MakeArray3, _MakeArray4, _MakeArray5, _MakeArrayN, _MakeHash, _MakeHash0, _MakeInvalidArgumentTypesError, _MakeMissingSuperException, _MakePrivateMethodCalledError, _MakeProtectedMethodCalledError, _MakeTopLevelSuperException, _MakeWrongNumberOfArgumentsError, _MatchLastInputLine, _MatchString, _MethodBreak, _MethodDefined, _MethodNext, _MethodProcCall, 
        _MethodRedo, _MethodRetry, _MethodYield, _PrintInteractiveResult, _PropagateRetrySingleton, _SerializeObject, _SetClassVariable, _SetCurrentException, _SetCurrentExceptionAndStackTrace, _SetGlobalConstant, _SetGlobalVariable, _SetInstanceVariable, _SetLocalVariable, _SetObjectClassVariable, _SetQualifiedConstant, _SetUnqualifiedConstant, _Splat, _SplatAppend, _SplatPair, _ToArrayValidator, 
        _ToFixnumValidator, _ToFloatValidator, _ToHashValidator, _ToIntegerValidator, _ToProcValidator, _ToRegexValidator, _ToSDefaultConversion, _ToStringValidator, _ToSymbolValidator, _TraceBlockCall, _TraceBlockReturn, _TraceMethodCall, _TraceMethodReturn, _TryGetClassVariable, _TryGetObjectClassVariable, _UndefineMethod, _Unsplat, _UpdateProfileTicks, _X, _Yield0, 
        _Yield1, _Yield2, _Yield3, _Yield4, _YieldN, _YieldSplat0, _YieldSplat1, _YieldSplat2, _YieldSplat3, _YieldSplat4, _YieldSplatN, _YieldSplatNRhs;
