...
namespace Microsoft.Scripting.Utils {
        ...
        private static Type GetHelperType(MethodInfo info, Type[] arrTypes) {
            ...
            if (info.ReturnType == typeof(void)) {
                switch (arrTypes.Length) {
                    ...
                    case 7: t = typeof(ActionHelper<,,,,,,>).MakeGenericType(arrTypes); break;
                    case 8: t = typeof(ActionHelper<,,,,,,,>).MakeGenericType(arrTypes); break;
                    case 9: t = typeof(ActionHelper<,,,,,,,,>).MakeGenericType(arrTypes); break;
                    default: throw new InvalidOperationException();
                }
            } else {
                switch (arrTypes.Length) {
                    ...
                    case 8: t = typeof(InvokeHelper<,,,,,,,>).MakeGenericType(arrTypes); break;
                    case 9: t = typeof(InvokeHelper<,,,,,,,,>).MakeGenericType(arrTypes); break;
                    case 10: t = typeof(InvokeHelper<,,,,,,,,,>).MakeGenericType(arrTypes); break;
                    default: throw new InvalidOperationException();
                }
            }
            return t;
    ...
    sealed class ActionHelper<T0, T1, T2, T3, T4, T5, T6> : ReflectedCaller {
        private Action<T0, T1, T2, T3, T4, T5, T6> _target;
    ...
    sealed class ActionHelper<T0, T1, T2, T3, T4, T5, T6, T7> : ReflectedCaller {
        private Action<T0, T1, T2, T3, T4, T5, T6, T7> _target;
    ...
    sealed class ActionHelper<T0, T1, T2, T3, T4, T5, T6, T7, T8> : ReflectedCaller {
        private Action<T0, T1, T2, T3, T4, T5, T6, T7, T8> _target;
    ...
    sealed class InvokeHelper<T0, T1, TRet> : ReflectedCaller {
        private Func<T0, T1, TRet> _target;
    ...
    sealed class InvokeHelper<T0, T1, T2, TRet> : ReflectedCaller {
        private Func<T0, T1, T2, TRet> _target;
    ...
    sealed class InvokeHelper<T0, T1, T2, T3, TRet> : ReflectedCaller {
        private Func<T0, T1, T2, T3, TRet> _target;
    ...
    sealed class InvokeHelper<T0, T1, T2, T3, T4, TRet> : ReflectedCaller {
        private Func<T0, T1, T2, T3, T4, TRet> _target;
    ...
    sealed class InvokeHelper<T0, T1, T2, T3, T4, T5, TRet> : ReflectedCaller {
        private Func<T0, T1, T2, T3, T4, T5, TRet> _target;
    ...
    sealed class InvokeHelper<T0, T1, T2, T3, T4, T5, T6, TRet> : ReflectedCaller {
        private Func<T0, T1, T2, T3, T4, T5, T6, TRet> _target;
    ...
    sealed class InvokeHelper<T0, T1, T2, T3, T4, T5, T6, T7, TRet> : ReflectedCaller {
        private Func<T0, T1, T2, T3, T4, T5, T6, T7, TRet> _target;
    ...
    sealed class InvokeHelper<T0, T1, T2, T3, T4, T5, T6, T7, T8, TRet> : ReflectedCaller {
        private Func<T0, T1, T2, T3, T4, T5, T6, T7, T8, TRet> _target;
